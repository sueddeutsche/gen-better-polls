...
df_ld <- read.csv("data/data-rolling-average.csv", stringsAsFactors = FALSE, sep = ",", encoding = "utf-8")
df_ci <- read.csv("data/data-ci-values.csv", stringsAsFactors = FALSE, sep=",", encoding ="utf-8")
