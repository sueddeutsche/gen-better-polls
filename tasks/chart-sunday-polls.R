...
do_basic_table_chart <- function(){
  ...
  article_chart <- sundaychart + geom_point(size = 6, shape = 124) + geom_label(aes(x = ci_higher,
  ...
  mobile_chart <- sundaychart + geom_point(size = 6.5, shape = 124) + geom_label(aes(x = ci_higher,
