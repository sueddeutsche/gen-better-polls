...
# Diagramm zusammen bauen
  ...
  ggsave(file=paste0("data/assets/longterm-poll-article-cdu.png"), plot=article_chart, dpi = 144, units = "in", width = 8.89, height = 5)
  ggsave(file=paste0("data/assets/longterm-poll-mobile-cdu.png"), plot=mobile_chart, dpi = 144, units = "in", width = 4.45, height = 3.33)
